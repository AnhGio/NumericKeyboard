...
open class NKInputView: UIView, UIInputViewAudioFeedback
{
    ...
    public enum NKKeyboardType : Int {
        ...
        /**
         A number pad (0-9). Suitable for PIN entry
         */
        case numberPadWithMovingControl
    }
    ...
    fileprivate var keyboardType: NKKeyboardType!
    ...
    @IBOutlet fileprivate var bDelete: NKKeyboardButton!
    ...
    @IBOutlet fileprivate var bForward: NKKeyboardButton!
    @IBOutlet fileprivate var bBackward: NKKeyboardButton!
    ...
    fileprivate func setup(_ textView: UITextInput, type: NKKeyboardType, returnKeyType: NKKeyboardReturnKeyType = .default)
    {
        ...
        bForward.isHidden = true
        bBackward.isHidden = true
        ...
        case .numberPadWithMovingControl:
            ...
            bForward.isHidden = false
            bBackward.isHidden = false
        }
